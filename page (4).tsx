...
export default function JobPage() {
  ...
  const availedAccommodationParam = searchParams.get("availedAccom") ?? undefined;
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-sm font-medium text-muted-foreground">Loading claim…</div>
        </div>
      </div>
    );
  }
  ...
  if (jobState === null) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background gap-4">
        <div className="text-xl font-display font-semibold text-foreground">Job not found</div>
        {!isEmbedded && (
          <Button
            type="button"
            variant="outline"
  ...
  return (
    <div className="h-screen bg-gray-100 flex flex-col overflow-hidden">
      <ResultView
        ...
        availedAccommodationOverride={availedAccommodationParam}
      />
    </div>
  );
}
